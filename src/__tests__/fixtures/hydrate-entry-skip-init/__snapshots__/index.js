...
var marko_template = module.exports = vdom.t(),
    ...
    marko_componentType = marko_registerComponent("/@marko/rollup$latest/src/__tests__/fixtures/hydrate-entry-skip-init/src/components/class-component.marko", function() {
